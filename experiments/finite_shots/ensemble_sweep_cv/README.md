...
| Run ID | `0904224422` |
| Jobs | 18 |
| Raw results | `data/Results_run/optuna_mixing_capacity_qrc_gaussian_results_0904224422/` |
| Aggregated results | `data/Results_averaged/optuna_mixing_capacity_qrc_gaussian_results_0904224422_combined.pkl` |
| Read by | Figure 6 |
...
```bash
cd code
python prepare_jobs.py --config ../experiments/finite_shots/ensemble_sweep_cv/grid.yaml
```
...
```bash
python average_runs_optuna.py --config ../experiments/finite_shots/ensemble_sweep_cv/grid.yaml --run-id 0904224422
```
